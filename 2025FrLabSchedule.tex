...
\item \rd: Driesch, pages 85--109.
	...
	\pc: Begin planaria
	experiment, observation and initial cutting. (Distribute ``Student Surgery Sheet''---\hyperlink{surgery.1}{\textcolor{Maroon}{not in manual}}---with pictures of expected results deleted.) % Add second sheet to pdfs
